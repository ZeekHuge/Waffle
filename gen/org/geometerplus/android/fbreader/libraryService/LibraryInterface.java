 ...
 * Original file: /Users/ishishuji/MyGit/bookreader/src/org/geometerplus/android/fbreader/libraryService/LibraryInterface.aidl
 */
...
boolean _arg1;
_arg1 = (0!=data.readInt());
boolean _result = this.saveBook(_arg0, _arg1);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
long _arg0;
_arg0 = data.readLong();
org.geometerplus.android.fbreader.api.TextPosition _result = this.getStoredPosition(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
long _arg0;
_arg0 = data.readLong();
org.geometerplus.android.fbreader.api.TextPosition _arg1;
if ((0!=data.readInt())) {
_arg1 = org.geometerplus.android.fbreader.api.TextPosition.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
...
@Override public void reset(java.util.List<java.lang.String> bookDirectories, boolean force) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStringList(bookDirectories);
...
@Override public boolean saveBook(java.lang.String book, boolean force) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public org.geometerplus.android.fbreader.api.TextPosition getStoredPosition(long bookId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
org.geometerplus.android.fbreader.api.TextPosition _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = org.geometerplus.android.fbreader.api.TextPosition.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public void storePosition(long bookId, org.geometerplus.android.fbreader.api.TextPosition position) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getRecentBook = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_authors = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_hasSeries = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_series = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_tags = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_labels = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_titles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_firstTitleLetters = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_saveBook = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_removeBook = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_addBookToRecentList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getStoredPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_storePosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_isHyperlinkVisited = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_markHyperlinkAsVisited = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_bookmarks = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_saveBookmark = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_deleteBookmark = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getHighlightingStyle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_highlightingStyles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_saveHighlightingStyle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
}
public void reset(java.util.List<java.lang.String> bookDirectories, boolean force) throws android.os.RemoteException;
...
public boolean saveBook(java.lang.String book, boolean force) throws android.os.RemoteException;
...
public org.geometerplus.android.fbreader.api.TextPosition getStoredPosition(long bookId) throws android.os.RemoteException;
public void storePosition(long bookId, org.geometerplus.android.fbreader.api.TextPosition position) throws android.os.RemoteException;
