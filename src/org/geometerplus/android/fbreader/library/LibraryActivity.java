...
import org.geometerplus.android.fbreader.tree.TreeActivity2;


public class LibraryActivity extends TreeActivity2<LibraryTree> implements MenuItem.OnMenuItemClickListener, View.OnCreateContextMenuListener, IBookCollection.Listener {
	static final String START_SEARCH_ACTION = "action.fbreader.library.start-search";
	private FBTree myOriginalParent;
...
//		TreeActivity2.my_list.setVisibility(View.GONE);
...
//					  parent=myOriginalParent;
//					  parent = myRootTree;
//					  openTree(myOriginalParent, myCurrentTree, false);
					  
				  }
				  else
				  { 
					  FBReader.closeApp(LibraryActivity.this);
				  }
			}
