...
final class NavigationPopup extends PopupPanel {
	...
	public void createControlPanel(FBReader activity, RelativeLayout root) {
		...
		final Button btnUp = (Button)layout.findViewById(R.id.button4);
		final Button btnDown = (Button)layout.findViewById(R.id.button5);
		final Button btnBack = (Button)layout.findViewById(R.id.button6);
