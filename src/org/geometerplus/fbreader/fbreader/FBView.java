...
public final class FBView extends ZLTextView {
	...
	private boolean isFlickScrollingEnabled() {
		...
		return
			...
			fingerScrolling == PageTurningOptions.FingerScrollingType.byTapAndFlick?true:false;
	}
	...
	public boolean onFingerMove(int x, int y,int num) {
		
		int i = num;
		
		if (super.onFingerMove(x, y,num)) {
			return true;
		}
		...
		synchronized (this) {
			...
			if (isFlickScrollingEnabled()) {
				myReader.getViewWidget().scrollManuallyTo(x, y,i);
